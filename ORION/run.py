...
width, height = 1920, 1080  # Keep camera resolution
...
while True:
    ...
    # Use the original frame for output
    output_image = np.zeros((720, 1280, 3), np.uint8)
    ...
    cv2.imshow("Final Image", cv2.resize(output_image, (1920, 1080)))  # Scale for projector
